...
public class KKAppEngCallouts
{
    ...
    public String validateOrderTotals(KKAppEng eng, OrderIf order)
    {
        ...
        {
            if (eng.getConfigAsBoolean("MODULE_ORDER_TOTAL_TAX_CLOUD_STATUS",
                    false /* default */,
                    true /* tryEngIfNotInCache */,
            ...
            if (eng.getConfigAsBoolean("MODULE_SHIPPING_USPS_STATUS",
                    false /* default */,
                    true /* try engine if not in cache */,
                    false /* warn if missing */))
            {
